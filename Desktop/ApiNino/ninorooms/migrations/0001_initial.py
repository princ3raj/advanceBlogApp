    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('pg_image', models.ImageField(blank=True, null=True, upload_to='')),
                ('pg_image_two', models.ImageField(blank=True, null=True, upload_to='')),
                ('pg_image_three', models.ImageField(blank=True, null=True, upload_to='')),
